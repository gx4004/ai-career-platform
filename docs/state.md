...
> - **R17 build-ahead posture:** #198–#200 are implemented, and the current
>   task explicitly authorizes continuing #201–#202 despite the older
...
>   recurring campaign/reviewer evidence is accepted. R16 remains gated by
>   D-100, and R10 triggers have not fired.
