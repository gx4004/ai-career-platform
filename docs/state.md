...
in FadeUp and FadeIn components. The accessibility/mobile route settle delay was
trimmed after hydration to keep the suite coverage intact while reducing E2E
runtime. PR #96 is green in CI as of 2026-07-07: frontend, backend, and E2E
Playwright/PostgreSQL checks all pass, with the E2E browser journey completing
in 7m28s and Playwright reporting `49 passed (6.0m)`.
