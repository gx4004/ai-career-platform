...
> **HISTORICAL — superseded, kept for reference.** This is the original 2026-03
> technical specification, written when the project intent was a live-monetization
> production launch. The product now runs in thesis demo mode and the current
> product contract lives in `docs/spec.md`. Where this document disagrees with
> `docs/spec.md`, `docs/decisions.md`, or executable code, those win (see the
> precedence order in `AGENTS.md`).
...
## Appendix — Superseded Development Roadmap (archived 2026-07-07)

> This appendix preserves, verbatim with headings demoted one level, the content
> that previously sat at `docs/spec.md` under the title "Career Workbench —
> Development Roadmap" (last updated 2026-03-31). It described a live-monetization
> launch posture that no longer matches reality: the product runs in thesis demo
> mode and monetization is deferred (see `docs/decisions.md` D-019/D-020/D-028).
> Current priorities live in `docs/roadmap.md`; the current product contract lives
> in `docs/spec.md`.
