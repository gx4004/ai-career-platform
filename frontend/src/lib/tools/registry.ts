...
export const tools: Record<ToolId, ToolDefinition> = {
  resume: {
    ...
    group: 'primary',
    priority: 1,
    summary: 'Score your resume, surface strengths, and prioritize what to fix.',
    entryPointLabel: 'Analyze resume',
    resultTitle: 'Resume analysis',
    emptyStateTitle: 'Analyze your current resume.',
    emptyStateBody: 'Upload your resume to seed the rest of the workflow.',
    nextActions: [
  ...
  'job-match': {
    ...
    group: 'primary',
    priority: 4,
    summary: 'Measure your fit against a target role and spot the gaps.',
    entryPointLabel: 'Match role',
    resultTitle: 'Job match result',
    emptyStateTitle: 'Measure fit against a live role.',
    emptyStateBody: 'Paste a job description alongside your resume to compare.',
    nextActions: [
  ...
  'cover-letter': {
    ...
    group: 'application',
    priority: 6,
    summary: 'Draft a cover letter grounded in your resume and the target role.',
    entryPointLabel: 'Generate cover letter',
    resultTitle: 'Cover letter draft',
    emptyStateTitle: 'Generate a tailored cover letter.',
    emptyStateBody: 'Add a real job description for the strongest first draft.',
    nextActions: [
  ...
  interview: {
    ...
    group: 'application',
    priority: 3,
    summary: 'Get role-specific questions with suggested answers to practice.',
    ...
    emptyStateBody: 'Uses your resume and role context so answers stay aligned.',
    nextActions: [
      { label: 'Write the cover letter', to: 'cover-letter', seed: 'resume+job' },
  ...
  career: {
    ...
    group: 'planning',
    priority: 2,
    summary: 'Compare career directions, timelines, and the skill gaps to close.',
    entryPointLabel: 'Recommend paths',
    resultTitle: 'Career path options',
    emptyStateTitle: 'Explore the next move.',
    emptyStateBody: 'Upload your resume to compare realistic transitions and gaps.',
    nextActions: [
  ...
  portfolio: {
    ...
    group: 'planning',
    priority: 5,
    summary: 'Turn your goals into project ideas that prove your fit.',
