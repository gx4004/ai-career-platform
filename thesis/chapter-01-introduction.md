...
Chapter 5 concludes the thesis by summarising the engineering and empirical contributions, restating the limitations, and identifying four future-work directions: Polish-language coverage, a sentence-transformer intermediate tier [20, 21], retrieval-augmented grounding for LLM outputs [25], and a Redis-backed shared cache.
